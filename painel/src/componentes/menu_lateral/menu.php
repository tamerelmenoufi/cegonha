...
<div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
  <div class="offcanvas-header">
    <img src="img/icone.png" style="height:100px;" alt="">
  ...
  <div class="offcanvas-body">
    ...
    <div class="row mb-1 menu-cinza">
      <div class="col">
        <a url="src/compras/index.php" class="text-decoration-none texto-cinza" data-bs-dismiss="offcanvas" aria-label="Close">
          <i class="fa-solid fa-clipboard-list"></i> Compras Confirmadas
        </a>
      </div>
    </div>
